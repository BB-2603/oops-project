...
export class AdminCard extends Component {
  ...
  render() {
    let { imgSrc, title, price, _id } = this.props;
      ...
      <div>
        <div className="card my-2" style={{ width: "18rem", marginLeft: "4rem" }}>
          ...
          <div className="card-body">
            ...
            <Link to="/Details" type="button" className="btn btn-outline-dark" onClick={() => this.detailsPage(_id)}>
              View Details
            </Link>
            <button
              type="button"
